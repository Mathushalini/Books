...
<form action="" method="POST">
  <div class="container">
    ...
    <label for="Name"><b>Custname</b></label>
    ...
    <input type="text" placeholder="Enter Your bookid " name="bookid" id="name" required>
    <hr>
     ...
     if(isset($_POST["submit"])){                                                           
        ...
        $bookid= $_POST["bookid"];
         ...
         if($connection->connect_errno){
           ...
           $sql="INSERT INTO orderbook(custname,phoneno,address,bookid)VALUES('$custname','$phoneno','$address','$bookid')";
